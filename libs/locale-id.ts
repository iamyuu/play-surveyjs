...
export const indonesianStrings = {
	...
	survey: {
		...
		dropQuestion:
			"Silahkan letakkan pertanyaan di sini dari Kotak Perkakas di sebelah kiri.",
	...
	ed: {
		...
		translationNoStrings:
			"Tidak ada string diterjemahkan. Silahkan ganti penyaring.",
		...
		themeResetConfirmation:
			"Apakah Anda benar-benar ingin mengatur ulang tema? Semua penyesuaian Anda akan hilang.",
		...
		surveyPlaceHolder:
			"Survei kosong. Seret elemen dari kotak alat atau klik tombol di bawah.",
		pagePlaceHolder:
			"Halaman kosong. Seret elemen dari kotak alat atau klik tombol di bawah.",
		imagePlaceHolder:
			"Seret dan lepas gambar di sini atau klik tombol di bawah ini dan pilih gambar untuk diunggah",
		surveyPlaceHolderMobile:
			'Klik tombol "Tambahkan Pertanyaan" di bawah ini untuk mulai membuat formulir Anda.',
		pagePlaceHolderMobile:
			'Klik tombol "Tambahkan Pertanyaan" di bawah ini untuk menambahkan elemen baru ke halaman.',
		panelPlaceHolderMobile:
			'Klik tombol "Tambahkan Pertanyaan" di bawah ini untuk menambahkan elemen baru ke panel.',
		imagePlaceHolderMobile:
			"Klik tombol di bawah ini dan pilih gambar untuk diunggah",
		...
		lg: {
			...
			page_visibilityDescription:
				"Membuat halaman terlihat saat ekspresi logika mengembalikan true. Jika tidak, jaga agar tidak terlihat.",
			panel_visibilityDescription:
				"Buat panel terlihat saat ekspresi logika mengembalikan true. Jika tidak, jaga agar tidak terlihat.",
			panel_enableDescription:
				"Buat panel, dan semua elemen di dalamnya, aktifkan saat ekspresi logika mengembalikan true. Jika tidak, biarkan mereka dinonaktifkan.",
			question_visibilityDescription:
				"Buat pertanyaan terlihat saat ekspresi logika mengembalikan true. Jika tidak, jaga agar tidak terlihat.",
			question_enableDescription:
				"Aktifkan pertanyaan saat ekspresi logika mengembalikan true. Jika tidak, tetap nonaktifkan.",
			question_requireDescription:
				"Pertanyaan menjadi diperlukan saat ekspresi logika mengembalikan true.",
			trigger_completeDescription:
				"Ketika ekspresi logika mengembalikan true maka survei menjadi selesai dan pengguna akhir melihat 'Halaman terima kasih'.",
			trigger_setvalueDescription:
				"Ketika nilai pertanyaan, yang digunakan dalam ekspresi logika, diubah dan ekspresi logika mengembalikan true, maka nilai diatur ke pertanyaan yang dipilih.",
			trigger_copyvalueDescription:
				"Ketika nilai pertanyaan, yang digunakan dalam ekspresi logika, diubah dan ekspresi logika mengembalikan true, maka nilai satu pertanyaan yang dipilih disalin ke pertanyaan lain yang dipilih.",
			trigger_skipDescription:
				"Ketika ekspresi logika mengembalikan true maka survei melompat ke / memfokuskan pertanyaan yang dipilih.",
			trigger_runExpressionDescription:
				"Ketika ekspresi logika mengembalikan true, maka ekspresi kustom dilakukan. Anda dapat secara opsional mengatur hasil ekspresi ini ke dalam pertanyaan yang dipilih",
			completedHtmlOnConditionDescription:
				"Jika ekspresi logika mengembalikan true, maka teks default untuk 'Halaman terima kasih' diubah ke yang diberikan.",
			...
			trigger_copyvalueText:
				"Salin ke pertanyaan: {0} nilai dari pertanyaan {1}", //{0} and {1} question names
			...
			completedHtmlOnConditionText:
				'tampilkan teks kustom untuk "Halaman terima kasih".',
			...
			expressionInvalid:
				"Ekspresi logika kosong atau tidak valid. Mohon koreksinya.",
			...
			uncompletedRule_text:
				"Anda belum menyelesaikan beberapa aturan logis. Jika Anda meninggalkan tab sekarang, perubahan akan hilang. Apakah Anda masih ingin meninggalkan tab tanpa menyelesaikan perubahan?",
	...
	pe: {
		...
		signaturepad: {
			...
			signatureAutoScaleEnabled:
				"Menskalakan area tanda tangan secara otomatis",
			showPlaceholder: "Memperlihatkan tempat penampung",
			placeholder: "Teks tempat penampung",
			placeholderReadOnly:
				"Teks tempat penampung dalam mode baca-saja atau pratinjau",
		...
		propertyNameIsIncorrect:
			'Jangan gunakan kata-kata khusus: "item", "pilihan", "panel", "baris".',
		...
		emptyLogicPopupMessage:
			"Pilih pertanyaan untuk mulai mengonfigurasi kondisi.",
		if: "Kalau",
		then: "kemudian",
		...
		cookieName:
			"Nama cookie (untuk menonaktifkan menjalankan survei dua kali secara lokal)",
		...
		showPrevButton:
			"Tampilkan tombol sebelumnya (pengguna mungkin kembali ke halaman sebelumnya)",
		firstPageIsStarted:
			"Halaman pertama pada survei adalah halaman yang telah dimulai.",
		...
		completedBeforeHtml:
			"Markup untuk menunjukkan apakah pengguna sudah mengisi survei ini",
		...
		separateSpecialChoices:
			"Pisahkan pilihan khusus (Tidak Ada, Lainnya, Pilih Semua)",
		...
		displayRateDescriptionsAsExtremeItems:
			"Menampilkan deskripsi tingkat sebagai nilai ekstrem",
		...
		keyboardAdornerTip:
			"Tekan tombol enter untuk mengedit item, tekan tombol hapus untuk menghapus item, tekan alt plus panah ke atas atau panah ke bawah untuk memindahkan item",
		triggerOn: "On ",
	...
	pehelp: {
		panel: {
			...
			visibleIf:
				"Gunakan ikon tongkat ajaib untuk menetapkan aturan bersyarat yang menentukan visibilitas panel.",
			enableIf:
				"Gunakan ikon tongkat ajaib untuk mengatur aturan bersyarat yang menonaktifkan mode baca-saja untuk panel.",
			requiredIf:
				"Gunakan ikon tongkat ajaib untuk menetapkan aturan bersyarat yang mencegah pengiriman survei kecuali setidaknya satu pertanyaan bertingkat memiliki jawaban.",
		...
		paneldynamic: {
			...
			width:
				"Mengatur lebar panel secara proporsional dengan elemen survei lainnya di baris yang sama. Menerima nilai CSS (px, %, in, pt, dll.).",
			templateTitle:
				"Ketik template untuk judul panel dinamis. Gunakan {panelIndex} untuk posisi umum panel dan {visiblePanelIndex} untuk urutannya di antara panel yang terlihat. Masukkan tempat penampung ini ke dalam pola untuk menambahkan penomoran otomatis.",
			templateTabTitle:
				"Ketik templat untuk judul tab. Gunakan {panelIndex} untuk posisi umum panel dan {visiblePanelIndex} untuk urutannya di antara panel yang terlihat. Masukkan tempat penampung ini ke dalam pola untuk menambahkan penomoran otomatis.",
			templateVisibleIf:
			...
			keyName:
				"Rujuk nama pertanyaan untuk mengharuskan pengguna memberikan respons unik untuk pertanyaan ini di setiap panel.",
		},
		...
		resetValueIf:
			'Gunakan ikon tongkat ajaib untuk mengatur aturan bersyarat yang menentukan kapan input responden diatur ulang ke nilai berdasarkan "Ekspresi nilai default" atau "Atur ekspresi nilai" atau ke nilai "Jawaban default" (jika salah satu diatur).',
		setValueIf:
			'Gunakan ikon tongkat ajaib untuk mengatur aturan bersyarat yang menentukan kapan harus menjalankan "Atur ekspresi nilai" dan secara dinamis menetapkan nilai yang dihasilkan sebagai respons.',
		setValueExpression:
		...
		question: {
			...
			visibleIf:
				"Gunakan ikon tongkat ajaib untuk menetapkan aturan bersyarat yang menentukan visibilitas pertanyaan.",
			enableIf:
				"Gunakan ikon tongkat ajaib untuk menetapkan aturan bersyarat yang menonaktifkan mode baca-saja untuk pertanyaan.",
			requiredIf:
				"Gunakan ikon tongkat ajaib untuk menetapkan aturan bersyarat yang mencegah survei maju atau dikirim kecuali pertanyaan menerima jawaban.",
			startWithNewLine:
				"Batalkan pilihan untuk menampilkan pertanyaan dalam satu baris dengan pertanyaan atau panel sebelumnya. Pengaturan tidak berlaku jika pertanyaan adalah elemen pertama dalam formulir Anda.",
			...
			titleLocation:
				'Mengganti aturan penyelarasan judul yang ditentukan pada tingkat panel, halaman, atau survei. Opsi "Warisi" menerapkan pengaturan tingkat yang lebih tinggi (jika diatur) atau pengaturan tingkat survei ("Atas" secara default).',
			descriptionLocation:
				'Opsi "Warisi" menerapkan setelan tingkat survei ("Di bawah judul pertanyaan" secara default).',
			errorLocation:
			...
			textUpdateMode:
				'Pilih dari: "On lost focus" - nilai diperbarui ketika bidang input kehilangan fokus; "Saat mengetik" - nilainya diperbarui secara real-time, saat pengguna mengetik. Opsi "Warisi" menerapkan pengaturan tingkat survei ("Pada fokus yang hilang" secara default).',
			...
			searchMode:
				"Operasi perbandingan yang digunakan untuk memfilter daftar turun bawah.",
			textWrapEnabled:
				"Teks panjang dalam opsi pilihan akan secara otomatis menghasilkan jeda baris agar sesuai dengan menu tarik-turun. Batalkan pilihan jika Anda ingin teks dipotong.",
		},
		signaturepad: {
			signatureWidth:
			...
			signatureAutoScaleEnabled:
				"Pilih apakah Anda ingin area tanda tangan mengisi semua ruang yang tersedia di dalam kotak pertanyaan sambil mempertahankan rasio aspek default 3:2. Saat nilai lebar dan tinggi kustom ditetapkan, pengaturan akan mempertahankan rasio aspek dimensi ini.",
		},
		file: {
		...
		matrixdropdowncolumn: {
			...
			isUnique:
				"Saat diaktifkan untuk kolom, responden diharuskan memberikan respons unik untuk setiap pertanyaan dalam kolom ini.",
			rows: "Mengatur jumlah baris yang ditampilkan di bidang input. Jika input mengambil lebih banyak baris, bilah gulir akan muncul.",
			visibleIf:
				"Gunakan ikon tongkat ajaib untuk mengatur aturan bersyarat yang menentukan visibilitas kolom.",
			enableIf:
				"Gunakan ikon tongkat ajaib untuk mengatur aturan bersyarat yang menonaktifkan mode baca-saja untuk kolom.",
			requiredIf:
				"Gunakan ikon tongkat ajaib untuk menetapkan aturan bersyarat yang mencegah pengiriman survei kecuali setidaknya satu pertanyaan bertingkat memiliki jawaban.",
			showInMultipleColumns:
				"Saat dipilih, buat kolom individual untuk setiap opsi pilihan.",
		},
		widthMode:
		...
		logoFit:
			'Pilih dari: "Tidak ada" - gambar mempertahankan ukuran aslinya; "Berisi" - gambar diubah ukurannya agar pas dengan tetap mempertahankan rasio aspeknya; "Cover" - gambar mengisi seluruh kotak sambil mempertahankan rasio aspeknya; "Isi" - gambar direntangkan untuk mengisi kotak tanpa mempertahankan rasio aspeknya.',
		goNextPageAutomatic:
		...
		showNavigationButtons:
			"Mengatur visibilitas dan lokasi tombol navigasi pada halaman.",
		showProgressBar:
			'Mengatur visibilitas dan lokasi bilah kemajuan. Nilai "Otomatis" menampilkan bilah kemajuan di atas atau di bawah header survei.',
		showPreviewBeforeComplete:
			"Aktifkan halaman pratinjau hanya dengan semua atau pertanyaan yang dijawab.",
		questionTitleLocation:
			"Berlaku untuk semua pertanyaan dalam survei. Setelan ini dapat diganti dengan aturan penyelarasan judul di tingkat yang lebih rendah: panel, halaman, atau pertanyaan. Pengaturan tingkat yang lebih rendah akan menggantikan pengaturan tingkat yang lebih tinggi.",
		requiredText:
			"Simbol atau urutan simbol yang menunjukkan bahwa jawaban diperlukan.",
		questionStartIndex:
			"Masukkan angka atau huruf yang ingin Anda gunakan untuk memulai penomoran.",
		questionErrorLocation:
			'Mengatur lokasi pesan kesalahan sehubungan dengan pertanyaan dengan input yang tidak valid. Pilih antara: "Atas" - teks kesalahan ditempatkan di bagian atas kotak pertanyaan; "Bawah" - teks kesalahan ditempatkan di bagian bawah kotak pertanyaan.',
		focusFirstQuestionAutomatic:
			"Pilih apakah Anda ingin bidang input pertama pada setiap halaman siap untuk entri teks.",
		questionsOrder:
			"Menyimpan urutan pertanyaan asli atau mengacaknya. Efek pengaturan ini hanya terlihat di tab Pratinjau.",
		...
		allowResizeComment:
			"Hanya untuk komentar pertanyaan dan pertanyaan Teks Panjang.",
		calculatedValues:
			"Variabel kustom berfungsi sebagai variabel perantara atau tambahan yang digunakan dalam perhitungan formulir. Mereka mengambil input responden sebagai nilai sumber. Setiap variabel kustom memiliki nama unik dan ekspresi yang menjadi dasarnya.",
		includeIntoResult:
			"Pilih apakah Anda ingin nilai terhitung ekspresi disimpan bersama dengan hasil survei.",
		triggers:
			'Pemicu adalah peristiwa atau kondisi yang didasarkan pada ekspresi. Setelah ekspresi dievaluasi ke "true", pemicu memicu tindakan. Tindakan semacam itu secara opsional dapat memiliki pertanyaan target yang dipengaruhinya.',
		clearInvisibleValues:
		...
		textUpdateMode:
			'Pilih dari: "On lost focus" - nilai diperbarui ketika bidang input kehilangan fokus; "Saat mengetik" - nilainya diperbarui secara real-time, saat pengguna mengetik.',
		columns:
			"Nilai kiri berfungsi sebagai ID kolom yang digunakan dalam aturan bersyarat, nilai kanan ditampilkan kepada responden.",
		...
		totalText:
			"Hanya terlihat bila setidaknya satu kolom memiliki Tipe total atau Ekspresi total.",
		cellErrorLocation:
			'Mengatur lokasi pesan kesalahan dalam kaitannya dengan sel dengan input yang tidak valid. Opsi "Warisi" menerapkan pengaturan dari properti "Perataan pesan kesalahan".',
		keyDuplicationError:
			'Ketika properti "mencegah duplikat respons" diaktifkan, responden mencoba untuk mengirimkan entri duplikat akan menerima pesan galat berikut.',
		totalExpression:
		...
		keyName:
			'Jika kolom yang ditentukan berisi nilai yang identik, survei akan memunculkan kesalahan "Nilai kunci tidak unik".',
		description: "Ketik subtitle.",
		locale:
			"Pilih bahasa untuk mulai membuat survei. Untuk menambahkan terjemahan, beralihlah ke bahasa baru dan terjemahkan teks asli di sini atau di tab Terjemahan.",
		detailPanelMode:
		...
		imageFit:
			'Pilih dari: "Tidak ada" - gambar mempertahankan ukuran aslinya; "Berisi" - gambar diubah ukurannya agar pas dengan tetap mempertahankan rasio aspeknya; "Cover" - gambar mengisi seluruh kotak sambil mempertahankan rasio aspeknya; "Isi" - gambar direntangkan untuk mengisi kotak tanpa mempertahankan rasio aspeknya.',
		autoGrow:
			'Secara bertahap meningkatkan ketinggian bidang input saat data dimasukkan. Mengganti setelan "Tinggi bidang input (dalam baris)".',
		allowResize:
			"Gagang pengubah ukuran (atau pegangan) muncul di sudut dan dapat diseret untuk mengubah ukuran bidang input.",
		maxTimeToFinish:
			"Interval waktu dalam hitungan detik setelah survei maju secara otomatis ke halaman Terima Kasih.",
		maxTimeToFinishPage:
			"Interval waktu dalam hitungan detik setelah survei maju secara otomatis ke halaman berikutnya.",
		page: {
			maxTimeToFinish:
				"Interval waktu dalam hitungan detik setelah survei maju secara otomatis ke halaman berikutnya.",
			visibleIf:
				"Gunakan ikon tongkat ajaib untuk menetapkan aturan bersyarat yang menentukan visibilitas halaman.",
			enableIf:
				"Gunakan ikon tongkat ajaib untuk mengatur aturan bersyarat yang menonaktifkan mode baca-saja untuk halaman.",
			requiredIf:
				"Gunakan ikon tongkat ajaib untuk menetapkan aturan bersyarat yang mencegah pengiriman survei kecuali setidaknya satu pertanyaan bertingkat memiliki jawaban.",
			questionTitleLocation:
				'Berlaku untuk semua pertanyaan dalam halaman ini. Jika Anda ingin mengganti setelan ini, tentukan aturan perataan judul untuk masing-masing pertanyaan atau panel. Opsi "Warisi" menerapkan setelan tingkat survei ("Teratas" secara default).',
			questionErrorLocation:
				'Mengatur lokasi pesan kesalahan sehubungan dengan pertanyaan dengan input yang tidak valid. Pilih antara: "Atas" - teks kesalahan ditempatkan di bagian atas kotak pertanyaan; "Bawah" - teks kesalahan ditempatkan di bagian bawah kotak pertanyaan. Opsi "Warisi" menerapkan setelan tingkat survei ("Teratas" secara default).',
			questionsOrder:
				'Menyimpan urutan pertanyaan asli atau mengacaknya. Opsi "Warisi" menerapkan setelan tingkat survei ("Asli" secara default). Efek pengaturan ini hanya terlihat di tab Pratinjau.',
			navigationButtonsVisibility:
				'Mengatur visibilitas tombol navigasi di halaman. Opsi "Warisi" menerapkan pengaturan tingkat survei, yang defaultnya adalah "Terlihat".',
		},
		showTimerPanel: "Mengatur visibilitas dan lokasi timer pada halaman.",
		panelsState:
			'Pilih dari: "Terkunci" - pengguna tidak dapat memperluas atau menciutkan panel; "Runtuhkan semua" - semua panel dimulai dalam keadaan diciutkan; "Perluas semua" - semua panel dimulai dalam keadaan diperluas; "Pertama diperluas" - hanya panel pertama yang awalnya diperluas.',
		imageLinkName:
			"Masukkan nama properti bersama dalam array objek yang berisi URL file gambar atau video yang ingin Anda tampilkan di daftar pilihan.",
		choices:
			"Nilai kiri berfungsi sebagai ID item yang digunakan dalam aturan bersyarat, nilai yang tepat ditampilkan kepada responden.",
		title: "Ketik judul yang mudah digunakan untuk ditampilkan.",
		waitForUpload:
			"Memastikan bahwa pengguna tidak akan menyelesaikan survei sampai file diunggah.",
		...
		clearIfInvisible:
			'Pilih apakah akan menghapus nilai pertanyaan yang disembunyikan oleh logika kondisional atau tidak dan kapan melakukannya. Opsi "Warisi" menerapkan setelan tingkat survei ("Setelah survei selesai" secara default).',
		...
		showOtherItem:
			"Saat dipilih, pengguna dapat menyertakan input tambahan di kotak komentar terpisah.",
		separateSpecialChoices:
			'Menampilkan setiap opsi pilihan khusus ("Tidak Ada", "Lainnya", "Pilih Semua") pada baris baru, bahkan saat menggunakan tata letak beberapa kolom.',
		...
		titleName:
			"Masukkan nama properti seragam dalam array objek yang berisi nilai yang ingin Anda tampilkan di daftar pilihan.",
		allowEmptyResponse:
			"Pilih untuk mengizinkan layanan mengembalikan respons atau array kosong.",
		choicesVisibleIf:
			"Gunakan ikon tongkat ajaib untuk mengatur aturan bersyarat yang menentukan visibilitas semua opsi pilihan.",
		rateValues:
			"Nilai kiri berfungsi sebagai ID item yang digunakan dalam aturan bersyarat, nilai yang tepat ditampilkan kepada responden.",
		rating: {
			displayMode:
				'"Otomatis" memilih antara mode "Tombol" dan "Tarik-turun" berdasarkan lebar yang tersedia. Ketika lebar tidak cukup untuk menampilkan tombol, pertanyaan menampilkan dropdown.',
		},
		valuePropertyName:
		...
		searchEnabled:
			"Pilih apakah Anda ingin memperbarui konten menu drop-down agar sesuai dengan kueri pencarian yang diketik pengguna di bidang input.",
		valueTrue:
		...
		selectToRankEnabled:
			"Aktifkan untuk memberi peringkat hanya pada pilihan yang dipilih. Pengguna akan menyeret item yang dipilih dari daftar pilihan untuk memesannya di dalam area peringkat.",
		dataList:
			"Masukkan daftar pilihan yang akan disarankan kepada responden saat masukan.",
		itemSize:
			"Pengaturan hanya mengubah ukuran bidang input dan tidak memengaruhi lebar kotak pertanyaan.",
		itemTitleWidth:
		...
		rateColorMode:
			'Menentukan warna emoji yang dipilih saat jenis ikon Peringkat diatur ke "Smiley". Pilih antara: "Default" - emoji yang dipilih muncul dalam warna survei default; "Skala" - emoji yang dipilih mewarisi warna dari skala peringkat.',
		expression: {
		...
		masksettings: {
			saveMaskedValue:
				"Pilih apakah Anda ingin menyimpan nilai pertanyaan dengan masker yang diterapkan dalam hasil survei.",
		},
		patternmask: {
			pattern:
				"Pola dapat berisi literal string dan placeholder berikut: '9' - untuk digit; 'a' - untuk huruf besar atau kecil; '#' - untuk digit atau huruf besar atau kecil. Gunakan garis miring terbalik '\\' untuk melarikan diri dari karakter.",
		},
		datetimemask: {
			pattern:
	...
	p: {
		...
		useDisplayValuesInDynamicTexts:
			"Menggunakan nilai tampilan dalam teks dinamis",
		visibleIf: "terlihat jika",
		...
		selectToRankEmptyRankedAreaText:
			"Teks untuk memperlihatkan jika semua opsi dipilih",
		selectToRankEmptyUnrankedAreaText:
			"Teks tempat penampung untuk area peringkat",
